# %%
# in this file, we only explain the model with no structure feature
import os
import sys
import random
print(os.getcwd())
...
# Load model
ckpt_path = '''
/home/zhuyeqi/gdrsnc/logs/mmp_withour_str_feature/runs/2024-12-07_12-46-12/checkpoints/epoch_116.ckpt
'''.strip()
