...
# Load model
ckpt_path = '''
/home/zhuyeqi/gdrsnc/logs/train/runs/2024-11-06_04-23-33/checkpoints/epoch_074.ckpt
'''.strip()
device = 'cpu'
...
# data related args
data_name = 'DHFR'
walk_length = [20,30,15,25,40,35]
num_sample = 10
num_structure_feat = 16     # this is from the hidden_size in the config file
batch_size = 32
p = 2
q = 0.6
dsl = 0
