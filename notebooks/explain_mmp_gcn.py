...
from src.data.gdr_datamodule import GDRDataModule
...
# Load model
ckpt_path = '''
/home/zhuyeqi/gdrsnc/logs/train/runs/2024-12-03_04-51-47/checkpoints/epoch_045.ckpt
'''.strip()

device = 'cpu'
model = BasicGNN.load_from_checkpoint(ckpt_path,
...
# load data
dm = GDRDataModule(name=data_name,
                     dsl=dsl,
