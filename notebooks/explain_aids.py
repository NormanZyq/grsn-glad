...
# Load model
ckpt_path = '''
/home/zhuyeqi/gdrsnc/logs/train/runs/2024-11-05_11-59-41/checkpoints/epoch_052.ckpt
'''.strip()
device = 'cpu'
...
num_sample = 5
num_structure_feat = 64     # this is from the hidden_size in the config file
batch_size = 32
p = 2
q = 0.6
dsl = 0
