...
from src.utils.baseline.gsn_utils.utils import degree

from src.utils.baseline.gsn_utils.models_misc import mlp
...
class DiscreteEmbedding(torch.nn.Module):
    ...
    def __init__(self, encoder_name,
        ...
        # -------------- for ogb: multi hot encoding of node features
            ...
            full_atom_feature_dims = get_atom_feature_dims() if kwargs[
                                                                    'features_scope'] == 'full' else get_atom_feature_dims()[
                                                                                                     :2]
        ...
        # -------------- for ogb: multi hot encoding of edge features
            ...
            full_bond_feature_dims = get_bond_feature_dims() if kwargs[
                                                                    'features_scope'] == 'full' else get_bond_feature_dims()[
                                                                                                     :2]
        ...
        for i in range(tensor.shape[1]):
            ...
            if self.aggr == 'concat':
                ...
                raise NotImplementedError(
                    'multi embedding aggregation {} is not currently supported.'.format(self.aggr))
